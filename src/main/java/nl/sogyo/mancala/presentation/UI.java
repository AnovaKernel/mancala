...
public class UI extends JFrame {
    ...
    public void paint(Graphics gfx) {
        ...
        gfx.drawString(bowl.getNeighbour(2).getBeads()+"", midX-stepX*1 + sizeX/2,midY+stepY + sizeY/2);
        gfx.drawString(bowl.getNeighbour(3).getBeads()+"", midX+stepX*1 + sizeX/2,midY+stepY + sizeY/2);
        ...
        gfx.drawString(bowl.getNeighbour(10).getBeads()+"", midX-stepX*1 + sizeX/2,midY-stepY + sizeY/2);
        gfx.drawString(bowl.getNeighbour(9).getBeads()+"", midX+stepX*1 + sizeX/2,midY-stepY + sizeY/2);
